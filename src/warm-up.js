...
}//NOTE: Did you mean `inStock` the variable you asked us to make? `stockCount` is gonna prevent my code from running.
...
var vegetables = ["Carrots", "Yams", "Zuchinni", "Shallots", "Spring Onions"]
...
// different fruits.
var fruits = ["Bananas", "Tomatoes", "Limes", "Apples", "Grapes", "Oranges", "Lemons"]
...
var groceryStore = {
  name: "the Wedge Community Co-op",
  isOpen: true,
  capacity: 350,
  curbsidePickup: true,
  instaCart: true,
}//NOTE: To illustrate that I'd thought about what other key value pairs could work I added a few.
